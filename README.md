...
For each item in an <i>array</i> of values, calculates the rolling average of <i>n</i> items. You can map each item in the array to a value with an optional <i>accessor</i> function.
